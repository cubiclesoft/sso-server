...
One final note:  I have found that a number of users take this product, modify it, and then show up on the forums later asking for help.  Inevitably, after discussing their situation, it is revealed that they have fundamentally broken the security of this system and unknowingly introduced critical security vulnerabilities into their installation.  If you find yourself modifying the product itself, please ask on the forums instead!  Not only do you avoid an unpleasant conversation about software security, but you'll ultimately benefit everyone else who might have the same needs as yourself through future constructive product improvements.
